var CompanyX = {
    ...
    record: {
        addFromEventDetailsForm: function (win, rec) {
            CompanyX.ShowMsg('Cita ' + rec.data.Title + ' fue agregada');
        },
        ...
        updateFromEventDetailsForm: function (win, rec) {
            CompanyX.ShowMsg('Cita ' + rec.data.Title + ' fue actualizada');
        },
        ...
        removeFromEventDetailsForm: function (win, rec) {
            CompanyX.ShowMsg('Cita ' + rec.data.Title + ' fue eliminada');
        },
        ...
        move: function (cal, rec) {
            rec.commit();
            CompanyX.ShowMsg('Cita ' + rec.data.Title + ' fue movida a ' + Ext.Date.format(rec.data.StartDate, 'F jS' + (rec.data.IsAllDay ? '' : ' \\a\\t g:i a')));
        },
